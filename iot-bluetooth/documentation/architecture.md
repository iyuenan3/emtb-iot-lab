...
| 层级 | 代码 | 职责 | 当前状态 |
| --- | --- | --- | --- |
| 界面 | `ContentView.swift` | 车辆、地图、记录、更多四页导航 | Build 13 已实现 |
...
| 远程服务 | `../iot-remote/` | 单车 TCP、HTTPS API、命令状态机 | 2026 年 8 月 22 日已部署 revision `dae2fc8` |
...
- 地图、基础位置、漂移过滤、D1 协调、布防、前台告警、骑行分段和保留清理已实现。离线移动推断仍未实现。
